...
from vigia_edge_worker.geometry import bbox_base_center, normalize_bbox, parse_polygon, point_in_polygon
...
class GeometryTest(unittest.TestCase):
    def test_parse_polygon_variants(self) -> None:
        ...
        self.assertEqual(parse_polygon({"points": [{"x": 0, "y": 0}, {"x": 1, "y": 0}, {"x": 1, "y": 1}]})[0], (0.0, 0.0))
